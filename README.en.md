...
![GitHub stars](https://img.shields.io/github/stars/cookaihq/social-card-skill?style=flat-square)
![License](https://img.shields.io/github/license/cookaihq/social-card-skill?style=flat-square)
...
```bash
npx skills add https://github.com/cookaihq/social-card-skill --skill social-card-skill
```

Or paste this to an AI agent with shell access:

```text
Install social-card-skill for me. Clone https://github.com/cookaihq/social-card-skill into ~/.claude/skills/social-card-skill, then verify that SKILL.md, assets/, and references/ exist.
```
...
> 2. Run `git clone https://github.com/cookaihq/social-card-skill.git ~/.claude/skills/social-card-skill`
...
```bash
git clone https://github.com/cookaihq/social-card-skill.git ~/.claude/skills/social-card-skill
```
...
AGPL-3.0 © 2026 [op7418](https://github.com/op7418) (original author) · fork maintained by [cookaihq](https://github.com/cookaihq)
