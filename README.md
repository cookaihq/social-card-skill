...
```text
帮我安装 social-card-skill。请把 https://github.com/cookaihq/social-card-skill 克隆到 ~/.claude/skills/social-card-skill,安装完成后检查 SKILL.md、assets/、references/ 是否存在。
```
...
> 2. 执行 `git clone https://github.com/cookaihq/social-card-skill.git ~/.claude/skills/social-card-skill`
...
AGPL-3.0 © 2026 [op7418](https://github.com/op7418)（原作者）· fork 由 [cookaihq](https://github.com/cookaihq) 维护
